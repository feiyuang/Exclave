...
require github.com/exclavenetwork/libexclavecore v0.0.0-20260906071941-b2a215ec2b26
...
require (
	...
	github.com/exclavenetwork/exclave-core/v5 v5.50.1-0.20260906071733-968c57beecda // indirect
